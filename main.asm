...
; export symbols
            ...
            XDEF ptrain6_init, ptrain6,blinkLED1, blinkLED1_init 
...
ptrain6_init:
            ...
            movb  #$07,TSCR2  ;div by 16: 24MHz/16 = 1.5 MHz
...
blinkLED1_init:
            movb  #$FF,DDRT   ;outputs
            movb  #$40,TIOS   ;select output compares 6 
            movb  #$07,TSCR2  ;div by 128: 24MHz/128 = 0.1875 MHz
            movb  #$80,TSCR1  ;enable timer
            movb  #$00,TC6 	  ;init cnt in TC6
            bset  TCTL1,#$10
            bset  TIE,#$40    ;enable TC6 interrupts
            cli               ;enable interrupts
            rts
...
; return address is at 0,sp
blinkLED1:
            movb  #$40,TFLG1  ;clear both C7F and C6F
            rts
